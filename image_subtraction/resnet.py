...
def cross_validate(technique, base_dir, k_folds):
    ...
    with open(f"{base_dir}/image_classification/resnet/metrics/{technique}_{chosen_body_part}_metrics.txt", "w") as file:
        ...
        for fold, (train_idx, test_idx) in enumerate(skf.split(videos, video_labels_numeric)):
            ...
            model_save_path = f"{base_dir}/image_classification/resnet/models/{technique}_{chosen_body_part}_fold_{fold+1}_model_new.keras"
